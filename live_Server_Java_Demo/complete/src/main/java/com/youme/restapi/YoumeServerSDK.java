...
public class YoumeServerSDK {
	private final String baseURL    = "https://api.youme.im:443/v2/";
	...
	private static final YoumeServerSDK instance = new YoumeServerSDK();
	private YoumeServerSDK (){}

	public static YoumeServerSDK getInstance(){
        return instance;
    }
    ...
    private String genCheckSum(long curtime) {
    	String encodeSrc = secretKey + restApikey + curtime;
